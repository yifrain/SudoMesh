...
\subsection{Bottom-up unsatisfiability aggregation}
\begin{figure}[htbp]
  \centering
...
\code{tasks/} (split/dedup/lease/steal/aggregate), \code{solver/} (search), \code{peer.py}
(orchestration), \code{cli.py} (demos + evaluation).
