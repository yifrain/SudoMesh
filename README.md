...
**Languages / 语言 / 語言:** English (below) · [简体中文](#中文设计文档) · detailed code-level docs in three languages → [`docs/`](docs/README.md) ([EN](docs/architecture.en.md) · [简](docs/architecture.zh-CN.md) · [繁](docs/architecture.zh-TW.md))
